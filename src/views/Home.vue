  ...
  <div class="home">
    ...
    <div id="container">
      ...
      <mt-swipe :auto="4000" class="swiper">
        <mt-swipe-item v-for="(img,index) in swipImgs" :key="index"><img :src="img" alt=""></mt-swipe-item>
      </mt-swipe>
      <!-- 分类 -->
  ...
  methods:{
    getData(){
      this.$axios('/api/profile/shopping').then(res =>{
        this.swipImgs = res.data.swipeImgs
    ...
    loadData(){
      ...
      // 获取商家信息
      this.$axios.post(`/api/profile/restaurants/${this.page}/${this.size}`,this.data).then(
        res=>{
          // console.log(res.data)
